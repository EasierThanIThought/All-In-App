    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                redirectActivity(PlantsActivity.this, MainActivity.class);
            }
        });
        ...
        pets.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(PlantsActivity.this, PetsActivity.class);
            }
        });
        ...
        decor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(PlantsActivity.this, DecorationActivity.class);
            }
        });
        ...
        workshop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(PlantsActivity.this, WorkshopActivity.class);
            }
        });
